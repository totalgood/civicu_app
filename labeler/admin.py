...
from .models import Image, Label, ImageLabel
...
#                              field.get_internal_type() not in unsearchable_field_types and
#                              field.name not in unsearchable_field_names]
