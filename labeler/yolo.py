...
if __name__ == '__main__':
    ...
    tb_counter = max([len(ls) for ls in os.listdir('/data/vsa/logs/')] or [0]) + 1
    tensorboard = TensorBoard(log_dir='/data/vsa/logs/' + str(tb_counter), histogram_freq=0, write_graph=True, write_images=False)
